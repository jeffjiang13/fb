...
function CreatePostPopup({ user }) {
  ...
  const postVideo = createPost.type === "video";
  ...
  const [picker, setPicker] = useState(false); // Added this line
            ...
            <div className={classes.content}>
              ...
              >
                <div
                  className={`${
                    postImage || postVideo
                      ? ImagePreviewStyles.header_wrapper
                      : ""
                  }`}
                >
                  <div
                  ...
                  <EmojiPickerBackground
                    ...
                    picker={picker} // Modified this line
                    setPicker={setPicker} // Modified this line
